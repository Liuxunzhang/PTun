...
`ptun` is a Linux-first per-process transparent proxy launcher. It avoids the `LD_PRELOAD` limitations of tools like proxychains by routing a launched process through a private network namespace and TUN device.
